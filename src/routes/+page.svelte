...
>
  ...
  <div class="flex items-end justify-between gap-3">
    <div class="min-w-0">
      ...
      <h1 class="mt-2 text-3xl font-bold leading-tight">Málaga</h1>
      <p class="text-sm text-white/90">Costa del Sol · Ronda · Granada · Córdoba 🇪🇸</p>
...
<main class="space-y-6 p-4 pb-12">
  ...
  <section>
    ...
    <input
      bind:value={q}
      placeholder="🔎 Buscar local (ex.: Alhambra, tapas, Ronda…)"
